(function () {
  ...
  document.title = `${product.name} — Rosalie`;
  ...
  container.innerHTML = `
    ...
    <div class="pd-info reveal-right">
      ...
      <div class="pd-trust-mini">
        <div><i class="fa-solid fa-truck-fast"></i> Free shipping on orders over $50</div>
        <div><i class="fa-solid fa-rotate-left"></i> 30-day easy returns</div>
        <div><i class="fa-solid fa-leaf"></i> Cruelty-free & vegan formula</div>
      </div>
      <div class="pd-tabs">
  ...
  document.querySelectorAll('#productDetail .pd-gallery, #productDetail .pd-info').forEach((el) => revealObserver.observe(el));
